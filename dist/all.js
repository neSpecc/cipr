  ...
  _createClass(Special, [{
    ...
    value: function render() {
      ...
      this.nodes.header = (0, _dom.make)('div', Special.CSS.header, {
        innerHTML: "\n        <a class=\"".concat(Special.CSS.headerLogo, " ").concat(Special.CSS.headerLogo, "--left\" href=\"").concat(_data.default.logoUrl, "\" target=\"_blank\"></a>\n        <a class=\"").concat(Special.CSS.headerLogo, " ").concat(Special.CSS.headerLogo, "--right\" href=\"").concat(_data.default.logoUrl, "\" target=\"_blank\"></a>\n        <a class=\"").concat(Special.CSS.headerLogo, " ").concat(Special.CSS.headerLogo, "--bottom-left\" href=\"").concat(_data.default.logoUrl, "\" target=\"_blank\"></a>\n        <a class=\"").concat(Special.CSS.headerLogo, " ").concat(Special.CSS.headerLogo, "--bottom-right\" href=\"").concat(_data.default.logoUrl, "\" target=\"_blank\"></a>\n      ")
      });
      /**
    ...
    value: function makeQuestion() {
      ...
      if (data.image) {
        ...
        this.nodes.mainText.appendChild((0, _dom.make)('div', Special.CSS.contentImageDisclaimer, {
    ...
    value: function findResult() {
      ...
      finalResult.message = "".concat((0, _helper.declineWord)(this.userPoints, ['Разгадан', 'Разгаданы', 'Разгадано']), " ").concat(this.userPoints, " ").concat((0, _helper.declineWord)(this.userPoints, ['шифр', 'шифра', 'шифров']), " \u0438\u0437 ").concat(this.totalLength);
      return finalResult;
    }
    /**
    ...
    key: "copyCode",
    value: function copyCode(image) {
      var code = image.dataset.code;
      (0, _helper.copyToClipboard)(code, function () {

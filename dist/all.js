...
exports.default = {
    ...
    questions: [{
        ...
        text: 'Сейчас мы живём в мире третьей индустриальной революции, но скоро должна случиться четвёртая. Выберите технологию, которая считается её частью.',
        options: [{
            id: 0,
            text: 'Интернет вещей',

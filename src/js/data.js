export default {
    ...
    <span></span>
    Речь на ЦИПР пойдёт обо всём от умных городов до влияния «цифровой экономики» на промышленность. Пройдёт конференция в Иннополисе неподалёку от Казани, так что лучше спланировать поездку заранее — с промокодом <strong>CIPR5</strong> стандартные билеты на ЦИПР будут стоить 5 000 рублей вместо 30 000.
    </div>`,
